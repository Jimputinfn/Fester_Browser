...
namespace SharpBrowser.Browser
{
    internal static class BrowserConfig
    {
        ...
        public static string UserAgent = " Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" + Cef.CefSharpVersion; // UserAgent to fix issue with Google account authentication		
        ...
        public static string UpdateCenter = "https://pastebin.com/raw/iSJJnvz5";
